...
Authors: David Mutchler, Dave Fisher, Matt Boutell, their colleagues,
         and Michael Kuznicki.  October 2018.
 ...
 s
    ...
    def rain(self, rain_amount):
        ...
        if rain_amount > self.water:
            n = self.water
            self.water = 0
            self.amount_rained = self.amount_rained + n
            return n
        else:
            self.water = self.water - rain_amount
            self.amount_rained = self.amount_rained + rain_amount
            return rain_amount
